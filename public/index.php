...
$appConfig = include dirname(__DIR__) . '/configs/application.config.php';
...
$moduleManager->getConfigListener()->addConfigGlobPath(dirname(__DIR__) . '/configs/autoload/*.config.php');
